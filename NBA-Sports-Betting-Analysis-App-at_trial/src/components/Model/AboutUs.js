...
import dylan from "../../assets/DylanJOB.jpg"
import UAS from "../../assets/anthonyLogo.png";
...
const teamMembers = [
  ...
  },
  {
    ...
    projects: [
      {
        name: 'Anthony Portfolio Website',
        imageUrl: UAS.src,
        description: 'A personalized website built utilizing React.',
        url: 'https://anthonythanpoovong.dev/',
      },
    ],
    testimonials: [
      {
  ...
  },
  {
    ...
    testimonials: [
      {
        quote: 'Working with Dyan and his team was a fantastic experience. They delivered beyond our expectations!',
        author: 'John Doe, CEO of Example Inc.',
      },
