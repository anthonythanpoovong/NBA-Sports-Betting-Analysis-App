...
const Register = ({ theme }) => {
  ...
  return (
    <div id="#register" className={`bg-${isDarkTheme ? 'gray-900' : 'white'} text-${isDarkTheme ? 'gray-300' : 'gray-900'} min-h-screen flex flex-col justify-center px-6 py-12 lg:px-8`}>
