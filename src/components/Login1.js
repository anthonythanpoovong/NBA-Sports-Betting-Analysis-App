...
const Login = ({ theme }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                throw new Error('Invalid1 credentials');
            }
        ...
        window.location.href = '/dashboard'; // Redirect to a protected page or dashboard
        } catch (error) {
    ...
    return (
        <div id="#login" className="bg-gray-900 text-gray-300 px-6 py-24 sm:py-32 lg:px-8 flex min-h-screen flex-col justify-center">
