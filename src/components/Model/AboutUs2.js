...
const AboutUs = () => {
  return (
    <div id="#about-us2" className="bg-gray-100 py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-base font-semibold uppercase tracking-wide text-indigo-600">About Us</h2>
          <p className="mt-1 text-4xl font-extrabold text-gray-900 sm:text-5xl lg:text-6xl">Meet Our Team</p>
          <p className="mx-auto mt-5 max-w-xl text-xl text-gray-500">We are a group of passionate developers committed to building great products.</p>
        </div>
            ...
            <div key={member.name} className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="mt-4 flex space-x-3">
                  <a href={member.github} className="text-gray-500 hover:text-gray-900">
                  ...
                  <a href={member.twitter} className="text-gray-500 hover:text-gray-900">
