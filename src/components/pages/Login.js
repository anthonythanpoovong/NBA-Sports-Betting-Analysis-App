...
const Login = ({ theme }) => {
    ...
    return (
        <div id="#login" className="bg-gray-900 text-gray-300 px-6 py-24 sm:py-32 lg:px-8 flex min-h-full flex-col justify-center">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form className="space-y-6" action="#" method="POST">
                    <div>
                        ...
                        <div className="mt-2">
                            <input id="email" name="email" placeholder="email@example.com" type="email" autoComplete="email" required
                    ...
                    <div>
                        <button type="submit"
                            className="flex w-full justify-center rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign in</button>
                    </div>
                </form>
                <p className="mt-10 text-center text-sm text-gray-500">
                    Not a member?
                    <a href="#register" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500"> Start an account today</a>
                </p>
            </div>
            <br/>
            <Footer theme="dark" />
